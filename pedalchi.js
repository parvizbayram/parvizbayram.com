(() => {
  ...
  function initScrollToTop() {
    const button = document.querySelector("[data-pedalchi-scroll-top]");
    if (!button) {
      return;
    }
  ...
  function blockMediaContextMenus() {
    ...
    const mediaBlocks = document.querySelectorAll(".pedalchi-media");
    ...
    const videoBlocks = document.querySelectorAll(".pedalchi-media.work-video");
    videoBlocks.forEach((block) => {
      if (block.querySelector(".pedalchi-media-shield")) {
        return;
      }
      ...
      shield.className = "pedalchi-media-shield";
  ...
  window.addEventListener("load", syncPedalchiScale, { once: true });
  window.addEventListener("resize", syncPedalchiScale, { passive: true });
})();
