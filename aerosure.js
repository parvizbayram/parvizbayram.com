(() => {
  ...
  function initScrollToTop() {
    const button = document.querySelector("[data-aerosure-scroll-top]");
    if (!button) {
      return;
    }
  ...
  function blockMediaContextMenus() {
    ...
    const mediaBlocks = document.querySelectorAll(".aerosure-media");
    ...
    videoBlocks.forEach((block) => {
      ...
      shield.className = "aerosure-media-shield";
  ...
  window.addEventListener("load", syncAerosureScale, { once: true });
  window.addEventListener("resize", syncAerosureScale, { passive: true });
})();
